"""
Django settings for silent_shape_dev_64602 project.
...
ROOT_URLCONF = 'silent_shape_dev_64602.urls'
...
WSGI_APPLICATION = 'silent_shape_dev_64602.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_shape_dev_64602 API",
    "DESCRIPTION": "API documentation for silent_shape_dev_64602 App",
    "VERSION": "v1",
}
